...
public class CourseStartReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        Notification n = new NotificationCompat.Builder(context, channel_id)
                ...
                .setContentTitle("Upcoming Product Notification")
                .setContentText("A new Product starts today!").build();
    ...
    private void createNotificationChannel(Context context, String CHANNEL_ID) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            CharSequence name = "Product Start Channel";
            String description = "Product Start Description";
